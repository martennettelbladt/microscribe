...
{
	rt_printf("hci_init inside hci.c\n"); //-----------------------------------------------------------------------
...
{
	rt_printf("hci_connect inside hci.c\n"); //--------------------------------------------------------
